export default function Perks({ selected, onChange }) {
  ...
  return (
    <div className="grid mt-2 grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
      ...
      <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
        <input type="checkbox" checked={selected.includes('entance')} name="entance" onChange={handelCbClick} />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
